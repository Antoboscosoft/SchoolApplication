...
import '../Assets/Stylesheetes/SpeechPocStyle/SpeechPOC.css';
    ...
    return (
        <div className={`main_div card ${activeTab === 'records' ? 'orange-bg' : (activeTab === 'notes' ? 'lightgray-bg' : '')}`}>
            ...
            <div className='Final-container mt-5 d-flex justify-content-center align-items-center main_content_actionpoint'>
                <div className='col'>
                    <div>
                        <h3 className='d-flex justify-content-center text-white'>Speech To Text (transcript)... </h3>
                    </div>
                    ...
                    <div className='tab-content'>
                        {activeTab === 'notes' && (
                            <div className='card' >
                                ...
                                <div className='card-body right-fix mt-2'>
                        ...
                        {activeTab === 'records' && (
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    ...
                                    <code className='fw-bold d-flex'>Speech To Text: {listening ? "(Microphone is [on])" : '(Microphone is [off])'}</code>
                                    <textarea placeholder='Speech to text here...' rows={10} cols={120} className='form-control textInput mb-2 mt-1' value={transcript}
                                    ...
                                    <button className='btn Icon_cancel mx-2 cancelbutton' title='Cancel' onClick={onCancel}>
                                        {transcript ? (
                                            ...
                                            // You might want to put an empty element or some other indicator when transcript is null
                                            null
                                        )}
                                    </button>
                                    ...
                                    <code className='fw-bold d-flex'>Chat-GPT Response:</code>
                                    <textarea id='chatGPT-response' value={chatGPTResponse} rows={12} readOnly placeholder='ChatGPT Response' className='form-control chatGPT-response w-100 mt-2'>
                                    </textarea>
                                </div>
